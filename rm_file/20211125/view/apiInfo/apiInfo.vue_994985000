<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="请求url" prop="url" width="120" />
        <el-table-column align="left" label="请求参数" prop="params" width="120" />
        <el-table-column align="left" label="所属项目" prop="project" width="120" />
        <el-table-column align="left" label="所属模块" prop="module" width="120" />
