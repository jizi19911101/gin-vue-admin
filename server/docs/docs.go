    ...
    "paths": {
        ...
        "/apiTestcase/apiTestcaseCode": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"success\":true,\"data\":{},\"msg\":\"同步并解析接口自动化代码成功！\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/envConfig/createEnvConfig": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建EnvConfig",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.EnvConfigReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/envConfig/deleteEnvConfigByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.OrganizationReq"
                        }
                    }
                ],
                "responses": {
