...
import (
	...
	//"github/jizi19911101/gin-vue-admin/server/plugin/email" // 本地插件仓库地址模式
	"github/jizi19911101/gin-vue-admin/server/plugin/example_plugin"
	"github/jizi19911101/gin-vue-admin/server/utils/plugin"
